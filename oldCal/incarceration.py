...
p_enroll_OAT_post_release = 0     # prob of enrolling OAT post release
p_enroll_Nal_post_release = 0     # prob of enrolling naltx post release
...
incarNIDUProb = 0.08
incarIDUProb = 0.15
incarProbScalar = incarParam
cal_MAT_disc_prob = 0.01
MATProbScalar = .05

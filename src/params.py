...
TIME_RANGE = 288       # total time steps to iterate
...
cal_ProgAIDS = 0.80              # Scaling factor for all progression to AIDS from HIV rates
...
inc_treat_HRsex_beh = False      # Remove sexual higrisk behaviour during treatment duration
inc_treat_IDU_beh = False         # Remove IDU behav:iour during treatment duration
...
PrEP_Target = 0.2              # Target coverage for PrEP therapy at 10 years (unused in non-PrEP models)
PrEP_startT = 48                 # Start date for PrEP program (0 for start of model)
...
PrEP_target_model = ['Couples']       # Allcomers, Clinical, Allcomers, HighPN5, HighPN10, SRIns, SR,Rec, MSM
PrEP_clinic_cat = 'HF'         # If clinical target model, which category does it follow

...
params.model.num_pop = 1100  # population size
params.model.time_range = 12  # total time steps to iterate
params.model.burn_duration = 12  # total time for burning in period (equillibration)
...
params.prep.target_model = "CDCwomen"  # Allcomers, Clinical, Allcomers

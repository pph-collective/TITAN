...
params.model.time.num_steps = 120  # total time steps to iterate
params.model.time.burn_steps = 36
...
params.calibration.acquisition = (
    1.0  # 0.92 # Global acquisition probability scaling factor
)
...
params.demographics["BLACK"].hiv.transmission = 3.75
...
params.prep.target_model = "Racial"  # Clinical, Allcomers
PrEP_init_var1 = 0.5
PrEP_init_var2 = 0.05
PrEP_clinic_cat = ""
...
"""
params.partnership.duration = {1: {}, 2: {}, 3: {}, 4: {}, 5: {}}
params.partnership.duration[1] = {"prob": 0.525, "min": 1, "max": 3}
params.partnership.duration[2] = {"prob": (0.525 + 0.300), "min": 3, "max": 12}
...
params.partnership.duration[5] = {"min": 13, "max": 24}

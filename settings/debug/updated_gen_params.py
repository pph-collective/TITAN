...
params.model.num_pop = 100  # population size
params.model.time_range = 12  # total time steps to iterate
params.model.burn_duration = 3  # total time for burning in period (equillibration)
...
params.assort_mix.type = "HR"  # Other assortative mixing types
...
params.needle_exchange.init_at_pop = 10
params.needle_exchange.coverage = 0.60
...
inc_treat_behavior = False  # Remove PWID behaviour during treatment duration
...
params.prep.target_model = "MSM"  # Allcomers, Clinical, Allcomers,MSM
...
Model Type for fast flag toggling
    ...
    params.features.high_risk         High risk behavior for incar or genPop

...
PrEP_disc = 0.15
PrEP_target_model = {
    "Clinical"  # Clinical, Allcomers, HighPN5, HighPN10, SRIns, SR,CDC,Racial
}
PrEP_init_var1 = 0.05
...
RaceClass1["ALL"] = {"Proportion": 0.488, "HAARTdisc": 0.018, "PrEPdisc": 0.0}
...
RaceClass2["ALL"] = {"Proportion": 0.512, "HAARTdisc": 0.018, "PrEPdisc": 0.0}

...
class TestLaplacian(object):
    ...
    def test_directed_laplacian(self):
        ...
        GL = numpy.array(
            [
                [0.9833, -0.2941, -0.3882, -0.0291, -0.0231, -0.0261],
        ...
        GL = numpy.array(
            [
                [1.0, -0.3062, -0.4714, 0.0, 0.0, -0.3227],
        ...
        GL = numpy.array(
            [
                [0.5, -0.1531, -0.2357, 0.0, 0.0, -0.1614],
    ...
    def test_directed_combinatorial_laplacian(self):
        ...
        GL = numpy.array(
            [
                [0.0366, -0.0132, -0.0153, -0.0034, -0.0020, -0.0027],
        ...
        GL = numpy.array(
            [
                [0.1395, -0.0349, -0.0465, 0, 0, -0.0581],
        ...
        GL = numpy.array(
            [
                [0.0698, -0.0174, -0.0233, 0, 0, -0.0291],

...
class TestImmediateDominators(object):
    ...
    def test_irreducible2(self):
        ...
        G = nx.DiGraph(edges)
        assert nx.immediate_dominators(G, 6) == {i: 6 for i in range(1, 7)}

    def test_domrel_png(self):
        # Graph taken from https://commons.wikipedia.org/wiki/File:Domrel.png
        edges = [(1, 2), (2, 3), (2, 4), (2, 6), (3, 5), (4, 5), (5, 2)]
        G = nx.DiGraph(edges)
        assert nx.immediate_dominators(G, 1) == {1: 1, 2: 1, 3: 2, 4: 2, 5: 2, 6: 2}
        # Test postdominance.
        with nx.utils.reversed(G):
            assert nx.immediate_dominators(G, 6) == {1: 2, 2: 6, 3: 5, 4: 5, 5: 2, 6: 6}

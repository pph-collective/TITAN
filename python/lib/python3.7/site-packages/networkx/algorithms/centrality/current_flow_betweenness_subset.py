...
def current_flow_betweenness_centrality_subset(
    ...
    try:
        ...
        raise ImportError(
            "current_flow_betweenness_centrality requires NumPy ", "http://scipy.org/"
        )
    try:
        import scipy
    except ImportError:
        raise ImportError(
            "current_flow_betweenness_centrality requires SciPy ", "http://scipy.org/"
        )
...
def edge_current_flow_betweenness_centrality_subset(
    ...
    for row, (e) in flow_matrix_row(H, weight=weight, dtype=dtype, solver=solver):
        ...
        betweenness[e] /= nb
    return dict(((ordering[s], ordering[t]), v) for (s, t), v in betweenness.items())

...
class Opts(object):
    ...
    skip_covered = optparse.make_option(
        "--skip-covered", action="store_true", help="Skip files with 100% coverage.",
    )
    ...
    show_contexts = optparse.make_option(
        "--show-contexts", action="store_true", help="Show contexts for covered lines.",
    )
...
CMDS = {
    "annotate": CmdOptionParser(
        "annotate",
        [Opts.directory, Opts.ignore_errors, Opts.include, Opts.omit,] + GLOBAL_ARGS,
    ...
    "erase": CmdOptionParser(
        "erase", GLOBAL_ARGS, description="Erase previously collected coverage data.",
    ),
    ...
    def command_line(self, argv):
        ...
        if options.action == "report":
            ...
            total = self.coverage.xml_report(
                outfile=outfile, skip_empty=options.skip_empty, **report_args
            )

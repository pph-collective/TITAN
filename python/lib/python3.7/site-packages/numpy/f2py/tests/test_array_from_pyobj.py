...
from numpy import array, alltrue, ndarray, zeros, dtype, intp, clongdouble
...
def setup_module():
    ...
    if wrap is None:
        ...
        src = [
            os.path.join(d, "src", "array_from_pyobj", "wrapmodule.c"),
...
if (
    intp().dtype.itemsize != 4 or clongdouble().dtype.alignment <= 8
...
class Array(object):
    def __init__(self, typ, dims, intent, obj):
        ...
        if intent.is_intent("cache"):
            ...
            self.pyarr = array(
                array(obj, dtype=typ.dtypechar).reshape(*dims),
...
class TestSharedMemory(object):
    ...
    def test_inplace(self):
        ...
        a.arr[1][2] = 54
        assert_(
            obj[1][2] == a.arr[1][2] == array(54, dtype=self.type.dtype),
            repr((obj, a.arr)),
        )

...
class vectorize(object):
    ...
    def _vectorize_call(self, func, args):
        ...
        if self.signature is not None:
            ...
            inputs = [array(a, copy=False, subok=True, dtype=object) for a in args]
            ...
            if ufunc.nout == 1:
                ...
                res = tuple(
                    [
                        array(x, copy=False, subok=True, dtype=t)
...
def _cov_dispatcher(
    m, y=None, rowvar=None, bias=None, ddof=None, fweights=None, aweights=None
):
...
def bartlett(M):
    ...
    n = arange(0, M)
    return where(
        less_equal(n, (M - 1) / 2.0), 2.0 * n / (M - 1), 2.0 - 2.0 * n / (M - 1)
    )
...
def delete(arr, obj, axis=None):
    ...
    if ndim == 0:
        ...
        warnings.warn(
            ...
            "from delete and raise an error",
            DeprecationWarning,
            stacklevel=3,
        )
        if wrap:
...
def insert(arr, obj, values, axis=None):
    ...
    if axis is None:
        ...
        warnings.warn(
            "in the future the special handling of scalars will be removed "
            "from insert and raise an error",
            DeprecationWarning,
            stacklevel=3,
        )

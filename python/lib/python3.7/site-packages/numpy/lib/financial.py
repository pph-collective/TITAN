...
_depmsg = (
    "numpy.{name} is deprecated and will be removed from NumPy 1.20. "
...
def _fv_dispatcher(rate, nper, pmt, pv, when=None):
    warnings.warn(_depmsg.format(name="fv"), DeprecationWarning, stacklevel=3)
...
def _pmt_dispatcher(rate, nper, pv, fv=None, when=None):
    warnings.warn(_depmsg.format(name="pmt"), DeprecationWarning, stacklevel=3)
...
def _nper_dispatcher(rate, pmt, pv, fv=None, when=None):
    warnings.warn(_depmsg.format(name="nper"), DeprecationWarning, stacklevel=3)
...
def _ipmt_dispatcher(rate, per, nper, pv, fv=None, when=None):
    warnings.warn(_depmsg.format(name="ipmt"), DeprecationWarning, stacklevel=3)
...
def _ppmt_dispatcher(rate, per, nper, pv, fv=None, when=None):
    warnings.warn(_depmsg.format(name="ppmt"), DeprecationWarning, stacklevel=3)
    return (rate, per, nper, pv, fv)
...
def _pv_dispatcher(rate, nper, pmt, fv=None, when=None):
    warnings.warn(_depmsg.format(name="pv"), DeprecationWarning, stacklevel=3)
...
def _rate_dispatcher(nper, pmt, pv, fv, when=None, guess=None, tol=None, maxiter=None):
    warnings.warn(_depmsg.format(name="rate"), DeprecationWarning, stacklevel=3)
...
def _irr_dispatcher(values):
    warnings.warn(_depmsg.format(name="irr"), DeprecationWarning, stacklevel=3)
    return (values,)
...
def _npv_dispatcher(rate, values):
    warnings.warn(_depmsg.format(name="npv"), DeprecationWarning, stacklevel=3)
    return (values,)
...
def _mirr_dispatcher(values, finance_rate, reinvest_rate):
    warnings.warn(_depmsg.format(name="mirr"), DeprecationWarning, stacklevel=3)
    return (values,)

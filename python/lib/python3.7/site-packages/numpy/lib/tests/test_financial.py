...
class TestFinancial(object):
    ...
    def test_pv_decimal(self):
        assert_equal(
            np.pv(Decimal("0.07"), Decimal("20"), Decimal("12000"), Decimal("0")),
    ...
    def test_ppmt_special_rate(self):
        assert_equal(
            np.round(np.ppmt(0.23 / 12, 1, 60, 10000000000), 8), -90238044.232277036
        )
    ...
    def test_ppmt_special_rate_decimal(self):
        ...
        assert_equal(
            np.ppmt(Decimal("0.23") / Decimal("12"), 1, 60, Decimal("10000000000")),
    ...
    def test_npv(self):
        assert_almost_equal(
            np.npv(0.05, [-15000, 1500, 2500, 3500, 4500, 6000]), 122.89, 2
        )
    ...
    def test_when(self):
        # begin
        assert_equal(
            np.rate(10, 20, -3500, 10000, 1), np.rate(10, 20, -3500, 10000, "begin")
        )
        # end
        assert_equal(
            np.rate(10, 20, -3500, 10000), np.rate(10, 20, -3500, 10000, "end")
        )
        assert_equal(
            np.rate(10, 20, -3500, 10000, 0), np.rate(10, 20, -3500, 10000, "end")
        )
        ...
        # end
        assert_equal(
            np.ipmt(0.1 / 12, 1, 24, 2000, 0), np.ipmt(0.1 / 12, 1, 24, 2000, 0, "end")
        )
        assert_equal(
    ...
    def test_decimal_with_when(self):
        ...
        # end
        assert_equal(
            np.rate(Decimal("10"), Decimal("20"), Decimal("-3500"), Decimal("10000")),
            np.rate(
        ...
        # end
        assert_equal(
            np.fv(Decimal("0.075"), Decimal("20"), Decimal("-2000"), Decimal("0")),
            np.fv(
    ...
    def test_broadcast(self):
        assert_almost_equal(
            np.nper(0.075, -2000, 0, 100000.0, [0, 1]), [21.5449442, 20.76156441], 4
        )
        ...
        assert_almost_equal(
            np.ppmt(0.1 / 12, list(range(5)), 24, 2000, 0, [0, 0, 1, "end", "begin"]),

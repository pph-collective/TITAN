...
if sys.platform == "win32":
    default_lib_dirs = ["C:\\", os.path.join(distutils.sysconfig.EXEC_PREFIX, "libs")]
...
def get_atlas_version(**config):
    ...
    try:
        s, o = c.get_output(
            atlas_version_c_text, libraries=libraries, library_dirs=library_dirs,
        )
...
class _numpy_info(system_info):
    ...
    def __init__(self):
        ...
        try:
            ...
            include_dirs.append(
                distutils.sysconfig.get_python_inc(prefix=os.sep.join(prefix))
            )
        except ImportError:
            pass

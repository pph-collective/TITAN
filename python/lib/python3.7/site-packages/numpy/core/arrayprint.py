...
def _get_formatdict(data, **opt):
    ...
    formatdict = {
        ...
        "float": lambda: FloatingFormat(data, prec, fmode, supp, sign, legacy=legacy),
        "longfloat": lambda: FloatingFormat(
            data, prec, fmode, supp, sign, legacy=legacy
        ),
...
class ComplexFloatingFormat(object):
    ...
    def __init__(self, x, precision, floatmode, suppress_small, sign=False, **kwarg):
        # for backcompatibility, accept bools
        if isinstance(sign, bool):
            sign = "+" if sign else "-"
        ...
        self.real_format = FloatingFormat(
            x.real, precision, floatmode_real, suppress_small, sign=sign, **kwarg
        )
        self.imag_format = FloatingFormat(
            x.imag, precision, floatmode_imag, suppress_small, sign="+", **kwarg
        )

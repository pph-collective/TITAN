...
class TestBasic(object):
    ...
    def test_from_object_array_unicode(self):
        A = np.array([["abc", u"Sigma \u03a3"], ["long   ", "0123456789"]], dtype="O")
    ...
    def test_from_unicode_array(self):
        A = np.array([["abc", u"Sigma \u03a3"], ["long   ", "0123456789"]])
...
class TestComparisonsMixed1(TestComparisons):
    ...
    def setup(self):
        ...
        self.B = np.array([["efg", "123  "], ["051", "tuv"]], np.unicode_).view(
            np.chararray
        )
...
class TestComparisonsMixed2(TestComparisons):
    ...
    def setup(self):
        TestComparisons.setup(self)
        self.A = np.array([["abc", "123"], ["789", "xyz"]], np.unicode_).view(
            np.chararray
        )
...
class TestMethods(object):
    ...
    def test_capitalize(self):
        ...
        tgt = [[u" \u03c3 ", ""], ["12345", "Mixedcase"], ["123 \t 345 \0 ", "Upper"]]
    ...
    def test_rstrip(self):
        ...
        tgt = [[u" \u03a3", ""], ["12345", "MixedCase"], ["123 \t 345", "UPPER"]]

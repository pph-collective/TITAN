...
class GitWildMatchTest(unittest.TestCase):
    ...
    def test_01_relative(self):
        ...
        pattern = GitWildMatchPattern(re.compile(regex), include)
        results = set(
            pattern.match(["spam", "spam/", "foo/spam", "spam/foo", "foo/spam/bar",])
        )
        self.assertEqual(
    ...
    def test_01_relative_nested(self):
        ...
        pattern = GitWildMatchPattern(re.compile(regex), include)
        results = set(pattern.match(["foo/spam", "foo/spam/bar", "bar/foo/spam",]))
    ...
    def test_04_prefix_wildcard(self):
        ...
        pattern = GitWildMatchPattern(re.compile(regex), include)
        results = set(
            pattern.match(["bar.py", "bar.py/", "foo/bar.py", "foo/bar.py/baz",])
        )
        self.assertEqual(
    ...
    def test_05_directory(self):
        ...
        pattern = GitWildMatchPattern(re.compile(regex), include)
        results = set(pattern.match(["dir/", "foo/dir/", "foo/dir/bar", "dir",]))
    ...
    def test_06_registered_deprecated(self):
		...
		"""
        self.assertIs(
            pathspec.util.lookup_pattern("gitignore"), pathspec.GitIgnorePattern
        )

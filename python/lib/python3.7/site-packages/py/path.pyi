...
class local(_PathLike[str]):
    ...
    def chmod(
        self, mode: int, rec: Union[int, str, Text, Callable[[local], bool]] = ...
    ) -> None: ...
    if sys.platform != "win32":
        def chown(
            self, user: Union[int, str], group: Union[int, str], rec: int = ...
        ) -> None: ...
    ...
    def open(
        self, mode: str = ..., ensure: bool = ..., encoding: Optional[str] = ...
    ) -> IO[Any]: ...
    ...
    def visit(
        ...
        fil: Optional[Union[str, Text, Callable[[local], bool]]] = ...,
        rec: Optional[
            Union[Literal[1, True], str, Text, Callable[[local], bool]]
        ] = ...,
    ...
    def write_text(
        self, data: Union[str, Text], encoding: str, ensure: bool = ...
    ) -> None: ...

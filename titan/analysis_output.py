...
def basicReport(
    ...
    for agentRace in MAIN_CAT:
        for agentTypes in SUB_CAT:
            ...
            if tmpReport.tell() == 0:
                tmpReport.write(
                    "run_id\trseed\tpseed\tnseed\tt\tTotal\tHIV\tAIDS\tTstd\tART\tHR\tIncid\tHR_6mo\tHR_Ev\tNewDiag\tDeaths\tPrEP\tIDUpart_PrEP\tMSMWpart_PrEP\ttestedPart_PrEP\tVaccinated\tLAI\tOral\tAware\n"
                )
